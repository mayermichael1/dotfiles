 ...
 * </p>
 */
@SuppressWarnings("unused") // This supression prevents latestMethod and latestValue to show up as unused as they are only used internally in JavaWiz
public class In {
  ...
  private static String latestMethod; // do not delete unused field - it is used internally by JavaWiz
  private static String latestValue; // do not delete unused field - it is used internally by JavaWiz
  ...
  // do not delete this "unused" method. Although not used by default JavaWiz JDI backend, it will be used by the JavaWiz Espresso backend for the input buffer visualization.
  public static String getLatestMethod() {
    return latestMethod;
  }

  // do not delete this "unused" method. Although not used by JavaWiz JDI backend, it will be used by the JavaWiz Espresso backend for the input buffer visualization.
   ...
   */
  public static String readQuoted() {
    StringBuffer b = new StringBuffer();
    char c = charAfterWhiteSpace();
    if (done && c == '"') {
      c = read();
